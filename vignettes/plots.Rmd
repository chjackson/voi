...
This vignette gives some demonstrations of how to illustrate VoI analyses graphically, using an example EVSI results dataset `chemo_evsi_or` supplied with the `voi` package. 
...
Note the `scales::dollar_format` trick here for showing large currency values tidily in the axis labels.
...
1.  The simple and fast method just searches among the sample sizes 
defined in the `evsi` object. 
