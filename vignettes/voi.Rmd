...
The known standard deviation defaults to 1, but can be changed, e.g. to 2, by calling \code{evsi} with an \code{aux_pars} argument, e.g. `evsi(..., aux_pars=list(sd=2), ...)`.
